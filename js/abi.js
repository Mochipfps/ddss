/* MiNI BRoKER — contract interfaces.

   STAKING ABI — the supplied ABI for the deployed contract
   0x0D91b7900A25C4F9e55528DA3A1A5B1b8B3a266f, included verbatim from
   "Mini broker abi.txt". Do not simplify, trim or retype it. */

window.MB_STAKING_ABI = [
  {
    "inputs": [],
...
/* Standard ERC-721 fragments used for the approval step before staking.
   Part of the public ERC-721 standard, not project-specific. */
window.MB_ERC721_ABI = [
